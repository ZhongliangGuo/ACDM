...
def main():
    ...
    parser.add_argument('--content_path', type=str, default='/home/zg34/datasets/COCO/train')
    parser.add_argument('--style_path', type=str, default='/home/zg34/datasets/PainterByNumber')
